...
public class ExtInfoModel {
    ...
    public Long getDataARPU() {
        return DataARPU;
    }

    public void setDataARPU(Long dataARPU) {
        DataARPU = dataARPU;
    }
    ...
    public String getCMCCPrds() {
        return CMCCPrds;
    }

    public void setCMCCPrds(String CMCCPrds) {
        this.CMCCPrds = CMCCPrds;
    }
}
